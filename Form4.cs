...
namespace ConnecBddAvengers
{
    public partial class Form4 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO SuperVilains (Id_SuperVilains,Nom_SuperVilains,Degats_SuperVilains,Commentaire_SuperVilains) VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox4.Text + "','" + textBox6.Text + "')";
        ...
        {
            con.Open();
            string query = "UPDATE SuperVilains SET Nom_SuperVilains = '" + textBox2.Text + "',Degats_SuperVilains='" + textBox4.Text + "',Commentaire_SuperVilains='" + textBox6.Text + "' WHERE Id_SuperVilains = '" + textBox1.Text + "'";
